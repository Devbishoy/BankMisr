...
public enum Condition {
    ...
    public static final String[] SIMPLE_OPERATION_SET = {
            "lk", "nl", "eq", "ne", "bw", "bn", "ew",
            "en", "nu", "nn", "gt", "ge", "lt", "le" };

    public static Condition getDataOption(final String dataOption){
        switch(dataOption){
            case "all": return ALL;
            case "any": return ANY;
            default: return null;
    ...
    public static Condition getSimpleOperation(final String input) {
        switch (input){
            case "lk": return LIKE;
            case "nl": return NOT_LIKE;
